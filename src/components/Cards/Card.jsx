...
const Card = ({ title, description, steps, image }) => {
  return (
    <div>
      <div className="custom-card position-relative round-3 d-flex flex-column align-items-center justify-content-between">
        ...
        <div className="steps-container text-center d-flex flex-column align-items-center">
          ...
          <div className="steps fw-semibold fs-18">{steps}</div>
        </div>
      </div>
    </div>
  );
